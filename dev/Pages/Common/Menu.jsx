        ...
        <div className="menubox">
          <div className="menu">
            ...
            <ul className="menu-list">
              ...
              <li className="item"><Link activeClassName="active" to="/components/plus">组件库</Link></li>
              <li className="item"><Link activeClassName="active" to="/help">帮助</Link></li> 
              <li className="item"><Link activeClassName="active" to="/reduxdom">Redux Dom {this.props.tips==0?"":<span className="tips">{this.props.tips}</span>}</Link></li> 
